...
class MockMCPClient:
    def complete(self, messages, **kwargs):
        return {"choices": [{"text": f"Processed: {messages[-1]['content']}", "index": 0, "logprobs": None, "finish_reason": None}], "usage": {"total_tokens": 10}}
...
def test_chain_memory(chain):
    ...
    chain.add_step({
        "name": "step2",
        "prompt": "Use previous analysis: {step1_response}"
    })
