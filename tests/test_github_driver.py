...
class TestGitHubDriver(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_config = {"api_key": "test-key", "test_mode": True}
    ...
    def test_list_repositories(self):
        ...
        request = MCPRequest(
            ...
            metadata={"action": "list_repositories", "service_type": "non_llm"},
        )
    ...
    def test_get_repository(self):
        ...
        request = MCPRequest(
            ...
            metadata={"action": "get_repository", "service_type": "non_llm"},
        )
    ...
    def test_search_code(self):
        ...
        request = MCPRequest(
            ...
            metadata={"action": "search_code", "service_type": "non_llm"},
        )
    ...
    def test_create_issue(self):
        ...
        request = MCPRequest(
            ...
            metadata={"action": "create_issue", "service_type": "non_llm"},
        )
    ...
    def test_invalid_action(self):
        ...
        request = MCPRequest(
            model="github",
            parameters={},
            metadata={"action": "invalid_action", "service_type": "non_llm"},
        )
