...
This document outlines the planned enhancements to fully align OmniXy with the three-component Model Context Protocol (MCP) architecture: client, server, and protocol.
